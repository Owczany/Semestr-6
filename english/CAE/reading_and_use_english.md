...
impoverished -> zubożały = very poor
...
Thames
```
moor (noun) -> an open area of  hills covered with grass, especially in Britain

the Yorkshire moors

to moor (verb) -> to tie a boat so that it stays in the same place
moored
```
shipping forecast
```
